<template>
  <!-- 库存：采购页面 -->
  <div class="inventory-purchase" style="height:100%">
    <!-- 头部 -->
    <div class="purchase-header-wrapper flex justify-between align-items">
      <div class="purchase-header-left flex">
        <Select-Input
          style="marginRight:10px;width:150px"
          :options="purchaseStateList"
          placeholder="全部状态"
        ></Select-Input>
        <Select-Input
          style="marginRight:10px;width:120px"
          :options="purchaseDateList"
          placeholder="请选择"
        ></Select-Input>
      ...
      <div class="purchase-header-right flex">
        <div class="add-purchaser-wrapper">
          <button
            ...
            class="btn-success"
          >新增采购申请</button>
          <div v-show="showAddPurchaser" class="popper-wrapper">
            <Dialog-Purchase @showAddPurchaser="showAddPurchaser=false"></Dialog-Purchase>
          </div>
        </div>
        <div class="upload">
...
/********************局部组件***************/
// 新建弹窗申请弹窗
import DialogPurchase from "./dialog/dialogPurchase";
// 采购列表组件
              ...
              .right {
                ...
                .dialog-wrapper {
                  ...
                  .dialog {
                    ...
                    /*底部*/
                    .dialog-footer {
                      -webkit-box-shadow: 6px 0 6px 1px rgba(0, 0, 0, 0.15);
                      box-shadow: 6px 0 6px 1px rgba(0, 0, 0, 0.15);
                      padding: 14px 24px;
