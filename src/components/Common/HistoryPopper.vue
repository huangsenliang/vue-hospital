  ...
  <div class="history-popper">
    <div class="mr-history-content">
      ...
      <div class="history-btn flex">
        <div>
          <el-button class="button-small" :plain="true" @click="openPopper">复制医嘱处方</el-button>
        </div>
        <div>
          <el-button class="button-small" :plain="true" @click="openPopper">复制病历</el-button>
        </div>
        <!-- 打印弹窗 -->
        <div class="dy-wrapper">
          <button class="button-small" @click="showPopper_dy=!showPopper_dy">打印</button>
...
<style scoped>
@import "../../assets/css/Common/HistoryPopper/HistoryPopper.css";
/*打印页面的页头页尾*/
@page {
  size: auto;
  width: 100%;
